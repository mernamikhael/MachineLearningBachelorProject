...
def user(userID,userIDA,per,perA,andriod,ios,andA,iosA,weightTopic,weightLang,weightpost,weighttag,weightfre):
    ...
    weekposts51A,weekposts50A,personalityDay[per],scoreTagA,scoreTagB,weightfre)
